...
namespace IntegralLib.Tests
{
    ...
    public class RectangleintegralTests
    {
        ...
        [TestMethod()]
        public void RectangleIntegralCalculateTestNumb9()
        {
            double leftSide = 221;
            double rightSide = 316.4356;
            double expected = 315.3830151232644;
            Rectangleintegral TestingIntegral = new Rectangleintegral(leftSide, rightSide);
            double result = TestingIntegral.RectangleIntegralCalculate();
            Assert.AreEqual(expected, result);
        }
        [TestMethod()]
        public void RectangleIntegralCalculateTestNumb10()
        {
            double leftSide = 11092;
            double rightSide = 12392;
            double expected = 4311.261330950229;
            Rectangleintegral TestingIntegral = new Rectangleintegral(leftSide, rightSide);
            double result = TestingIntegral.RectangleIntegralCalculate();
            Assert.AreEqual(expected, result);
        }
